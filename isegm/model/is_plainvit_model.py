...
from .modeling.models import PatchEmbed, VisionTransformer
...
class PlainVitModel(ISModel):
    ...
    def backbone_forward(self, image, coord_features=None, points=None):
        ...
        backbone_features, gcns = self.backbone.forward_backbone(image, coord_features, self.random_split, points)
        ...
        return {'instances': self.head(multi_scale_features), 'instances_aux': None, 'gcns': gcns}
