...
def save_checkpoint(net, checkpoints_path, epoch=None, prefix='', verbose=True, distributed=False, ema=None, swa=None): # ema_net
    if epoch is None:
    ...
    torch.save({'state_dict': net.state_dict(),
                ...
                'swa_state_dict': swa.state_dict() if swa else None,
