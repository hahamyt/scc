...
class OpenImagesDataset(ISDataset):
    def __init__(self, dataset_path, split='train', **kwargs):
        ...
        self._images_path = self._split_path / 'data'
        self._masks_path = self._split_path / 'labels/masks/'
    ...
    def get_sample(self, index) -> DSample:
        ...
        m_path = random.choice(mask_paths)
        mask_path = str(self._masks_path / m_path[0] / m_path)
