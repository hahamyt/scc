...
from isegm.data.datasets.love_da import LoveDADataset
from isegm.data.datasets.rice import RiceDataset
...
def get_dataset(dataset_name, cfg):
    if dataset_name == 'GrabCut':
        ...
        dataset = BerkeleyDataset(cfg.BERKELEY_PATH, name='Berkeley')
        ...
        dataset = PascalVocDataset(cfg.PASCALVOC_PATH, split='val', name='PascalVOC')
    elif dataset_name == 'COCO_MVal':
        dataset = DavisDataset(cfg.COCO_MVAL_PATH, name='COCO_MVal')
        ...
        dataset = RiceDataset(cfg['IS_RICE_PATH'], split="val")
    elif dataset_name == 'LoveDA':
        dataset = LoveDADataset(cfg['IS_LoveDA_PATH'], split="val")
    else:
        dataset = None
...
def get_results_table(noc_list, over_max_list, brs_type, dataset_name, mean_spc, elapsed_time, mean_cigr,
