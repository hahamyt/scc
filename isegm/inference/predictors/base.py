...
class BasePredictor(object):
    ...
    def get_prediction(self, clicker, prev_mask=None):
        ...
        pred_logits, _, gcns = self._get_prediction(image_nd, clicks_lists, is_image_changed)
        ...
        return prediction.cpu().numpy()[0, 0], gcns
    ...
    def _get_prediction(self, image_nd, clicks_lists, is_image_changed):
        ...
        # print(macs)
        # print(params)
        return self.net(image_nd, points_nd).values()
