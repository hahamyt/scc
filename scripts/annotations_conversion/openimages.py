...
def create_annotations(dataset_path, dataset_split='train'):
    ...
    _images_path = _split_path / 'data'
    _masks_path = _split_path / 'labels/masks'
    ...
    with open(_split_path / f'labels/segmentations.csv', 'r') as f:
        ...
        for row in reader:
            ...
            if (_images_path / f'{image_id}.jpg').is_file() \
                    and (_masks_path / image_id[0] / mask_path).is_file():
